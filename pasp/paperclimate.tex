...
\caption{Atmospheric opacity models for the Colombian Andes for different precipitable water vapor (pwv) values corresponding to three scenarios: \textit{Red line} (20 mm pwv) a 2600 masl site with 90\% relative humidity at 13$^\circ$C, \textit{Blue line} (10 mm pwv) a 3400 masl site with 90\% relative humidity at 0$^\circ$C, \textit{Red line} (2 mm pwv) a 3400 masl site with 30\% relative humidity at 0$^\circ$C.}\label{opac}
\end{center}
\end{figure}
